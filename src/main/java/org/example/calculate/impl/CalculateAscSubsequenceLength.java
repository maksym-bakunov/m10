...
public class CalculateAscSubsequenceLength implements Calculate<Map<CalculationTypes, Integer>> {
    @Override
    public Map<CalculationTypes, Integer> calculateArray(ArrayList<Long> arrayList, int start, int end) {
        ...
        result.put(CalculationTypes.POSITION_MAX_SEQ_ASC, arr[0][0]);
        result.put(CalculationTypes.MAX_SEQ_ASC, arr[0][1]);
    ...
    public CalculationTypes getCalculationType() {
        return CalculationTypes.MAX_SEQ_ASC;
    }
}
